...
export default function OurFriendsItem({ _id, title, url, addressUrl, imageUrl, address, workDays, phone, email }) {
    ...
    return (
        ...
        <ItemContainer >
          ...
          <div >
            <Field >Time: </Field>
            <TimeInfo>{workDays ===  null ? 'day and night' : 
                `09.00 : 17.00`}</TimeInfo>
            <Field>
            Address:
            </Field>
            <Link
